...
class EditTaskFragment : Fragment() {
    ...
    lateinit var evm: EditTaskFragmentViewModel
    ...
    override fun onAttach(context: Context) {
        ...
        evm = ViewModelProvider(
            requireActivity(),
            viewModelFactory
        ).get(EditTaskFragmentViewModel::class.java)
    }
    ...
    override fun onCreateView(
        ...
        importancePreviewTextView.text = when (evm.newTask.value?.priority) {
            ...
            TaskItemPriorities.HIGH -> {
                importancePreviewTextView.setTextColor(
        ...
        dateSwitch.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked) {
                DatePickerFragment.newInstance(
                    ...
                    show(this@EditTaskFragment.childFragmentManager, DIALOG_DATE)
                }
            } else {
